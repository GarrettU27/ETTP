...
from backend.ecg_plot import plot, save_as_png
from backend.get_ecg_from_db import convert_to_millivolts
from backend.sqlite_setup import get_sqlite_connection

patient_ids = [11223, 11225, 11226, 11227, 11228, 16, 29, 31, 20, 44, 65, 11, 54, 91, 103, 106, 37, 47, 57, 82, 101,
               278, 396, 579, 869, 988]
